...
def clear():
    if name == 'nt':
        ...
        system('clear')
print(colorama.Fore.RED + "[+] " + colorama.Fore.LIGHTBLUE_EX + "Gãi chym đợi tí nhé fen")       
time.sleep(10)
wms = [
  '''
  ...
  while True:
    ...
    if 'credit' in cmdl:
      ...
      ╔═════════╩═════════════════════════════════╩═════════╗
        ...
        - Bản quyền            : KillT920(La văn Hiếu)
        - ZALO                 : 0398342590
        - FACEBOOK             : La Văn Hiếu (Hiếu Hoa Hồng)
                   CẢM ƠN ĐÃ SỬ DỤNG KillT920 DDOS
